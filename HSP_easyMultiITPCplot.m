function HSP_easyMultiITPCplot(cfg, data)
% HSP_EASYMULTIITPCPLOT is a function, which makes it easier to plot a 
...
if cfg.part == 1                                                                 
  trialinfo = data(cfg.dyad).part1.trialinfo;                               % get specific trialinfo and
  dataPlot  = data(cfg.dyad).part1;                                         % extract data of selected participant
elseif cfg.part == 2
  trialinfo = data(cfg.dyad).part2.trialinfo;
  dataPlot  = data(cfg.dyad).part2;
  
end

cfg.cond = HSP_checkCondition( cfg.cond );                                  % check cfg.condition definition    
